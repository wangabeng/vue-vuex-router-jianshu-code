<template>
	<div class="login-container">
		...
		<div class="login-header">
			<a href='javascript:void(0)' @click='tablogin("login")' :class='{active:showlogin=="login"}'>&nbsp;&nbsp;&nbsp;&nbsp;登录&nbsp;&nbsp;&nbsp;&nbsp;·</a>
			<a href='javascript:void(0)' @click='tablogin("register")' :class='{active:showlogin=="register"}'>&nbsp;&nbsp;&nbsp;&nbsp;注册&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
		<div class="login-input" v-if='showlogin=="login"'>
			<form class="form_login" accept-charset="UTF-8" method="post">
				...
				<div class="login-control" style="color:#555555;font-size:12px;">
					<span style="float:left" class="checkbox" >
		...
		<div class="login-input" v-if='showlogin=="register"'>
